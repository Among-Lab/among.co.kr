...
<tr><td width="20" height="455"><img src="../images/space.gif" width="20" height="1"></td>
	...
	<!----------- 서브메뉴 ------------------->
		...
		<script>var objf=fflash("img/sub_menu.swf?mainNum=1",190,258,"submenu","transparent");documentwrite(objf);</script>
		</DIV></DIV>
		</td></tr>		
		</table>
	...
	<tr><td valign="top" style="padding-top:12px"><img src="img/tit_image.gif"></td>
		<td align="right" valign="top" style="padding-top:15px">
		<table cellspacing="0" cellpadding="0" border="0">
		<tr><td valign="top" nowrap class="mtext02"><img src="../images/icon_home.gif"> <a href='../' target='_top' class="cate">Home</a> &gt  <font color="#888888">고객지원</font> &gt  <font color="#888888">영상인식솔루션</font></td></tr>
		</table>		
	</td></tr>
	</table>
	...
	<!----------- 내용 ----------------------->
		...
		<table cellspacing="0" cellpadding="0" border="0" width="640">			
		<tr><td><img src="img/img_03.jpg" border="0" usemap="#img"></td></tr>
		</table>


		<map name="img">		
		  <area shape="rect" coords="120,123,267,218" href="../product/dvr.php" onfocus="this.blur()" />	
		  <area shape="rect" coords="380,123,525,218" href="../product/wat.php" onfocus="this.blur()" />	
	
		</map>
		
		<!--table cellspacing="0" cellpadding="0" border="0" width="640">			
		<tr><td><img src="img/img_02.jpg" border="0" usemap="#img"></td></tr>
		</table>

		
		<map name="img">		
		  <area shape="rect" coords="478,271,615,300" href="../product/dvr.php">		
		</map-->	
