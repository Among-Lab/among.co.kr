...
<tr><td width="20" height="455"><img src="../images/space.gif" width="20" height="1"></td>
	...
	<!----------- 서브메뉴 ------------------->
		...
		<script>var objf=fflash("img/sub_menu.swf?mainNum=0",190,258,"submenu","transparent");documentwrite(objf);</script>
		</DIV></DIV>
		</td></tr>		
		</table>
	...
	<tr><td valign="top" style="padding-top:12px"><img src="img/tit_repair.gif"></td>
		<td align="right" valign="top" style="padding-top:15px">
		<table cellspacing="0" cellpadding="0" border="0">
		<tr><td valign="top" nowrap class="mtext02"><img src="../images/icon_home.gif"> <a href='../' target='_top' class="cate">Home</a> &gt  <font color="#888888">고객지원</font> &gt  <font color="#888888">유지보수</font></td></tr>
		</table>		
	</td></tr>
	</table>
	...
	<!----------- 내용 ----------------------->
		...
		<table cellspacing="0" cellpadding="0" border="0" width="640">			
		<tr><td height="360"><img src="img/img_01.jpg" border="0" usemap="#img"></td></tr>
		</table>

		<map name="img">
		  <area shape="poly" coords="78,214,107,134,155,73,259,180,231,216" href="../product/repair.php">
		    <area shape="poly" coords="156,72,226,29,320,12,319,158,260,179" href="../product/repair.php">
			  <area shape="poly" coords="320,11,402,25,482,72,378,179,319,156" href="../product/wat.php">
			    <area shape="poly" coords="482,74,532,134,559,214,407,214,381,178" href="../product/repair.php">
