...
<tr><td width="20" height="455"><img src="../images/space.gif" width="20" height="1"></td>
	...
	<tr><td valign="top" style="padding-top:12px"><img src="img/tit_notice.gif"></td>
		<td align="right" valign="top" style="padding-top:15px">
		<table cellspacing="0" cellpadding="0" border="0">
		<tr><td valign="top" nowrap class="mtext02"><img src="../images/icon_home.gif"> <a href='../' target='_top' class="cate">Home</a> &gt  <font color="#888888">고객지원</font> &gt  <font color="#888888">공지사항</font></td></tr>
		</table>		
	</td></tr>
	</table>
	...
	<!----------- 내용 ----------------------->
		...
		<iframe id="if_bbs_id" name="if_bbs_" src="bbs_notice.php?<?=$_SERVER[QUERY_STRING]?>" style="width:640px;" vspace="0" hspace="0" marginwidth="0" marginheight="0" frameborder="0" scrolling="no" ALLOWTRANSPARENCY="true" onload='resizeIframe(this);'></iframe>
			</td></tr>
		</table>
